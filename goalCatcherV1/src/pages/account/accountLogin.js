      ...
      <View>
        ...
        <ImageBackground
          ...
          <View
            ...
            <Text style={this.state.signUpStyle}>Login</Text>
          </View>
          ...
          <View
            ...
            <View
              style={{ marginLeft: 35, alignItems: 'flex-end', flex: 1 / 7 }}>
              <CheckBox checked={this.state.isSelected} onPress={this.select} />
            </View>
